...
public class Cola {
    ...
    public boolean poner(Object nuevoElem) {
        ...
        if (esVacia()) {
            //Si la cola está vacía entonces tanto el fin como el frente tendrán el nodo nuevo con el elemento.
            this.fin = nuevo;
            this.frente = nuevo;
        } else {
    ...
    public Cola clone() {
        ...
        if (!esVacia()) {
            ...
            while (aux1 != null) {
                //Mientras aux1 no está vacía entonces a aux2 le setea un nuevo nodo con el elemento de aux1.
